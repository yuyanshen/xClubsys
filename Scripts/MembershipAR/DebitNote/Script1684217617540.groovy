...
WebUI.verifyElementText(findTestObject('Object Repository/Page_MembershipAR - NUSS/h2_Debit Note List'), 'Debit Note List')

WebUI.verifyElementText(findTestObject('Page_MembershipAR - NUSS/md-tab-item_Void'), 'VOID')
...
WebUI.verifyElementText(findTestObject('Page_MembershipAR - NUSS/md-tab-item_Draft'), 'DRAFT')
