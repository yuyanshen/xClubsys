...
WebUI.navigateToUrl(GlobalVariable.url + '/Inventory/Pickings/Outgoings')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Inventory - NUSS/h2_Outgoings'), 'Outgoings')
...
WebUI.verifyElementText(findTestObject('Page_Inventory - NUSS/a_New Outgoing'), 'NEW OUTGOING')
