...
WebUI.navigateToUrl(GlobalVariable.url + '/Inventory/Pickings/Incomings')

WebUI.verifyElementText(findTestObject('Page_Inventory - NUSS/h2_Incomings'), 'Incomings')

WebUI.verifyElementText(findTestObject('Page_Inventory - NUSS/a_New Incoming'), 'NEW INCOMING')
...
WebUI.verifyElementText(findTestObject('Page_Inventory - NUSS/md-tab-item_Waiting Approval'), 'WAITING APPROVAL')
